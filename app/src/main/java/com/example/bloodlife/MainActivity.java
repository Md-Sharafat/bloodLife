    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "To access sign in first", Toast.LENGTH_SHORT).show();
        ...
        helpline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(MainActivity.this,NationalHelpLine.class);
                startActivity(intent);
                finish();
        ...
        groupText.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(MainActivity.this, "Group"+item, Toast.LENGTH_SHORT).show();
            }
        });
